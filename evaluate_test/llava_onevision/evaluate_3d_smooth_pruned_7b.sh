#!/bin/bash
# LLaVA-OneVision 7B with 3D Soft-Smoothing PRUNED Evaluation
...
echo "=================================================="
echo "VSI-Bench Evaluation: 7B + 3D Prune"
echo "=================================================="
echo "Model: llava-onevision-qwen2-7b-ov (Prune)"
echo "Alpha: $ALPHA"
echo "Frames: 16"
...
accelerate launch \
    ...
    $LIMIT_ARG \
    --log_samples \
    --log_samples_suffix llava_onevision_7b_prune_${ALPHA} \
    --output_path ./logs/vsibench_7b_prune_alpha${ALPHA}

echo "=================================================="
echo "Complete! Results: ./logs/vsibench_7b_prune_alpha${ALPHA}}"
echo "=================================================="

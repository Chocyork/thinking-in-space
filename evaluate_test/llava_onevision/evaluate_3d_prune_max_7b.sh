#!/bin/bash
# LLaVA-OneVision 7B with 3D Salience-Based Pruning (Max Norm) Evaluation
...
echo "=================================================="
echo "VSI-Bench Evaluation: 7B + 3D Salience Pruning"
echo "=================================================="
...
accelerate launch \
    ...
    $LIMIT_ARG \
    --log_samples \
    --log_samples_suffix llava_onevision_7b_prune_max \
    --output_path ./logs/vsibench_7b_prune_max

echo "=================================================="
echo "Evaluation Complete!"
echo "Results: ./logs/vsibench_7b_prune_max"
echo "=================================================="

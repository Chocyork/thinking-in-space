#!/bin/bash
# LLaVA-OneVision 0.5B with DA3-2dir + Smoothing + Max Pruning (v2)
...
echo "=================================================="
echo "VSI-Bench: 0.5B + DA3-2dir + Smooth+MaxPrune v2"
echo "=================================================="
...
accelerate launch \
    ...
    $LIMIT_ARG \
    --log_samples \
    --log_samples_suffix llava_0.5b_da3_smooth_max_v2_${ALPHA} \
    --output_path ./logs/vsibench_da3_smooth_max_v2_${ALPHA}

echo "=================================================="
echo "Complete! Results: ./logs/vsibench_da3_smooth_max_v2_${ALPHA}"
echo "=================================================="

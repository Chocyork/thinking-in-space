#!/bin/bash
# LLaVA-Video 7B with 3D Soft-Smoothing Evaluation (16 frames)
...
echo "=================================================="
echo "VSI-Bench: LLaVA-Video-7B + 3D Smooth"
echo "=================================================="
...
accelerate launch \
    ...
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix llava_video_7b_smooth_${ALPHA} \
    --output_path ./logs/vsibench_llava_video_7b_smooth_alpha${ALPHA}

echo "=================================================="
echo "Complete! Results: ./logs/vsibench_llava_video_7b_smooth_alpha${ALPHA}"
echo "=================================================="
